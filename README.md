...
برای مستندسازی پروژه‌های مبتنی بر بینایی ماشین به‌ویژه خانواده YOLO، وجود یک فایل README.md ساختاریافته و آکادمیک و یک فایل .gitignore بهینه برای جلوگیری از آپلود فایل‌های حجیم (مانند وزن‌ها و مجموعه‌داده‌ها)، از اصول اولیه و ضروری مهندسی نرم‌افزار است.ساختار استاندارد و فنی این دو فایل
۱. محتویات فایل .gitignore مخصوص پروژه‌های YOLO
از آنجا که در پروژه‌های YOLO وزن‌های مدل (.pt)، مجموعه‌داده‌های حجیم (تصاویر و برچسب‌ها) و فایل‌های کشِ پایتون و ابزارهایی مانند TensorBoard تولید می‌شوند، فایل .gitignore زیر به صورت کاملاً اختصاصی برای مدیریت این موارد طراحی شده است:
# ==========================================
...
# ==========================================
# Dataset & Weights (Do NOT push to GitHub)
# ==========================================
# Exclude SeaShips dataset folders
**/datasets/
**/data/SeaShips/
**/datasets/SeaShips/
*.zip
...
# Exclude YOLO model weights (Official & Custom checkpoints)
*.pt
*.onnx
*.engine
runs/
